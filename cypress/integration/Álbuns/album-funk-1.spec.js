describe('Álbum - Ostentabug', () => {
   ...
   describe('Verificando o carregamento dos componentes da página ', () => {
    ...
    it('Botão Play "Tocar Todas"', () => {
        cy.get('#play-all > .icon').should('exist')
    })
  ...
  describe('Verificando o texto dos componentes da página ', () => {
    ...
    it('Nome do Álbum', () => {
        cy.get('.is-size-6').should('contain','Ostentabug')
    })
    it('Título - Musicas', () => {
    ...
    it('Nome da Musica', () => {
        cy.get('.columns > :nth-child(2) > .is-size-5').should('contain','Baile de Tabela')
    })
    it('Nome da Banda', () => {
