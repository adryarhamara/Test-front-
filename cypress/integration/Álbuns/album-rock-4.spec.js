...
describe('Álbum - NullVana', () => {
  ...
  describe('Verificando o texto dos componentes da página ', () => {
    ...
    it('Nome do Álbum', () => {
        cy.get('.is-size-6').should('contain','Nerver Testing')
    })
    it('Título Musicas', () => {
    ...
    it('Nome da Musica', () => {
        cy.get('.columns > :nth-child(2) > .is-size-5').should('contain','Windows My Ass')
    })
    it('Nome da Banda', () => {
        cy.get(':nth-child(2) > p').should('contain','NullVana')
    })
  })
