...
describe('Categoria - Sertanejo', () => {
    before(() => {
        cy.login()
        cy.visit('/categories/4')
   })
   describe('Verificando o carregamento dos componentes da página ', () => {
    ...
    describe('Verificando o texto dos componentes da página ', () => {
        ...
        it('Título - Sertanejo', () => {
            cy.get('.is-size-3').should('contain','Sertanejo')
        })
        it('Título - Albuns', () => {
        ...
        it('Nome - Album', () => {
            cy.get('#albums > .columns > .column > .has-text-white > .is-size-6').should('contain','Acustico')
        })
        it('Nome - Banda Sertaneja', () => {
            cy.get('.is-size-7').should('contain','Marcus e Debug')
        })
    })
    describe('Musicas - Rock', () => {
     ...
     describe('Verificando o carregamento dos componentes da página', () => {
       ...
       describe('Verificando o texto dos componentes da página', () => {
        ...
        it('Nome da Musica', () => {
            cy.get('.is-size-5').should('contain','Bug de Manhã')
        })
        it('Nome da Banda Sertaneja', () => {
            cy.get(':nth-child(2) > p').should('contain','Marcus e Debug')
        })
      })
     }) 
   })
